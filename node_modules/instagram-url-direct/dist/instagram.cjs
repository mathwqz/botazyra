...
async function getCSRFToken(baseURL, data) {
    try {
        let config = {
            method: 'post',
        ...
        const token = await new Promise((resolve, reject) => {
            axios_1.default.request(config).catch((err) => {
                var _a, _b;
                if (!((_a = err.response) === null || _a === void 0 ? void 0 : _a.headers['set-cookie'])) {
                    reject(err);
                }
                else {
                    const csrfCookie = (_b = err.response) === null || _b === void 0 ? void 0 : _b.headers['set-cookie'][0];
